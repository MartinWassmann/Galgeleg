...
import static com.example.galgelegs185033.MainActivity.playerName;
...
public class createGame extends AppCompatActivity implements View.OnClickListener {
        ...
        int antalForkerte = 0;
        ImageView Galge;
        CountDownTimer sleeptimerLost;
        CountDownTimer sleeptimerWon;
        public static String ord;

        @Override
        protected void onCreate(Bundle savedInstanceState) { //buttonVelkommen in activity_main.xml is there, but never used, because the constraints are bound to it.
        ...
        public void onClick(View v) {
            ...
            if(R.id.buttonStart == v.getId()) {
                ...
                antalForkerte = 0;
                final String ord = spil.getOrdet();
            }
        ...
        private void opdaterSkærm() {
            ...
            if (spil.erSpilletTabt()) {
                ...
                sleeptimerLost = new CountDownTimer(1500, 1000) {
        ...
        private void lostGame() {
            Intent goToLostScreen = new Intent(this, gameLost.class);
            startActivity(goToLostScreen);
        }

        private void wonGame() {
            Intent goToWonScreen = new Intent(this, gameWon.class);
            startActivity(goToWonScreen);
        }
}
